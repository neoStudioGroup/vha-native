...
<blockquote>
<p>cordova plugin add cordova-plugin-Capture</p>
</blockquote>
<h3>提供的剪贴板管理</h3>
</section>
<!-- ------------------------------------------- -->
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/src/pages/_data/Capture.md" target="_blank">在 GitHub 上编辑此页</a>
