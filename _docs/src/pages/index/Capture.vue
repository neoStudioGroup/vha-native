<template>
  <div class="index_PG-Capture">
<!-- ------------------------------------------- -->
<section id="Capture">

<h1><strong><a href="#Capture">Capture</a></strong></h1>
...
<blockquote>
<p>cordova plugin add cordova-plugin-media-capture</p>
</blockquote>
<br />
...
<pre><code class="language-javascript">captureAudio: function () {
  let options = {
    limit: 1,
    duration: 10
  }
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a class="ui-r-a" href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/_data/Capture.md" target="_blank">在 GitHub 上编辑此页</a>
