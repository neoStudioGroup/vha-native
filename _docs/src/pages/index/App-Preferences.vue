<template>
  <div class="index_PG-App Preferences">
<!-- ------------------------------------------- -->
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a class="ui-r-a" href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/_data/App Preferences.md" target="_blank">在 GitHub 上编辑此页</a>
