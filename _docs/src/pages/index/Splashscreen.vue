<template>
  <div class="index_PG-Splashscreen">
<!-- ------------------------------------------- -->
<section id="Splashscreen">

<h1><strong><a href="#Splashscreen">Splashscreen</a></strong></h1>
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a class="ui-r-a" href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/_data/Splashscreen.md" target="_blank">在 GitHub 上编辑此页</a>
