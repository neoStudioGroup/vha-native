<template>
  <div class="index_PG-Flashlight">
<!-- ------------------------------------------- -->
<section id="Flashlight">

<h1><strong><a href="#Flashlight">Flashlight</a></strong></h1>
...
<blockquote>
<p>cordova plugin add cordova-plugin-Flashlight</p>
</blockquote>
<h3>提供的剪贴板管理</h3>
</section>
<!-- ------------------------------------------- -->
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/src/pages/_data/Flashlight.md" target="_blank">在 GitHub 上编辑此页</a>
