<template>
  <div class="index_PG-Clipboard">
<!-- ------------------------------------------- -->
<section id="Clipboard">

<h1><strong><a href="#Clipboard">Clipboard</a></strong></h1>
<p><a class="ui-r-npm" href="https://www.npmjs.com/package/cordova-plugin-Clipboard" target="_blank">cordova-plugin-Clipboard</a></p>

<blockquote>
<p>cordova plugin add cordova-plugin-Clipboard</p>
</blockquote>
<h3>Cordova/PhoneGap剪贴板插件支持iOS，Android和Windows Phone 8提供的剪贴板管理。</h3>
</section>
<!-- ------------------------------------------- -->
<section id="Scenes">
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/src/pages/_data/Clipboard.md" target="_blank">在 GitHub 上编辑此页</a>
