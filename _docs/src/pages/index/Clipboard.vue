...
<blockquote>
<p>cordova plugin add cordova-plugin-vha-clipboard</p>
</blockquote>
<br />
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/_data/Clipboard.md" target="_blank">在 GitHub 上编辑此页</a>
