<template>
  <div class="index_PG-Camera">
<!-- ------------------------------------------- -->
<section id="Camera">

<h1><strong><a href="#Camera">Camera</a></strong></h1>
...
<pre><code class="language-javascript">Camera: function () {
  let options = {
    quality: 80,
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/_data/Camera.md" target="_blank">在 GitHub 上编辑此页</a>
