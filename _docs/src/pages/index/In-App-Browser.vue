...
<blockquote>
<p>cordova plugin add cordova-plugin-In-App-Browser</p>
</blockquote>
<h3>提供的剪贴板管理</h3>
</section>
<!-- ------------------------------------------- -->
...
<!-- ------------------------------------------- -->
    <section id="lastSection" class="_df _jcsb">
      <a href="https://github.com/neoStudioGroup/vha-native/blob/master/_docs/src/pages/_data/In App Browser.md" target="_blank">在 GitHub 上编辑此页</a>
